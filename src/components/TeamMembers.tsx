  ...
  return (
    <div className="mt-4 border-t border-line pt-4">
      <div className="flex items-center gap-2.5">
        ...
        <div className="ml-auto text-[11px] text-faint">Std.-PT je üblicher Sprintlänge · abweichende Längen werden anteilig umgerechnet</div>
      </div>
            ...
            >
              ...
              <form action={editMemberDays} className="flex items-center">
                ...
                <input
                  ...
                  placeholder="PT"
                  title="Standard-PT für einen Sprint üblicher Länge (Median der bisherigen Sprints); kürzere/längere Sprints werden anteilig umgerechnet. Leer = Arbeitstage des Sprints."
                  onBlur={(e) => {
